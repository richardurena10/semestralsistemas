...
<body>
    <br>
        ...
        <div class="top">
    <a href="p5.php"></a>
    <h1>Catálogo de productos de la ferreteria</h1>
<br>
<br>
...
<br>
            ...
            <form id="addToCartForm" action="productos.php" method="post">
    ...
    if(isset($_SESSION['carrito']) && !empty($_SESSION['carrito'])) {
        ...
        $total2 =0;
         ...
         foreach($_SESSION['carrito'] as $indice => $item) {
            ...
            echo "\n".'<td>'.$item['cantidad'].'</td>';
            echo '<td><a href="productos.php?eliminar='.$indice.'">Eliminar</a></td>';
            echo '</tr>';
...
<p><a href="productos.php?vaciar=1">Vaciar carrito</a></p>
